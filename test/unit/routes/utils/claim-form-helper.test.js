...
describe('Claim form helper tests', () => {
  ...
  test.each([
    ...
    expect(claimFormHelperResult.displayRecommendAction).toBe(expectedResult)
    expect(claimFormHelperResult.displayRecommendToPayForm).toBeFalsy()
    expect(claimFormHelperResult.displayRecommendToRejectForm).toBeFalsy()
    expect(claimFormHelperResult.displayAuthorisePaymentForm).toBeFalsy()
    expect(claimFormHelperResult.displayRejectClaimForm).toBeFalsy()
    expect(claimFormHelperResult.displayMoveToInCheckAction).toBeFalsy()
  ...
  test.each([
    ...
    const claimFormHelperResult = await claimFormHelper(request, applicationReference, applicationStatus)
    expect(claimFormHelperResult.displayRecommendAction).toBeFalsy()
    expect(claimFormHelperResult.displayRecommendToPayForm).toBe(expectedResult)
    expect(claimFormHelperResult.displayRecommendToRejectForm).toBeFalsy()
    expect(claimFormHelperResult.displayAuthorisePaymentForm).toBeFalsy()
    expect(claimFormHelperResult.displayRejectClaimForm).toBeFalsy()
    expect(claimFormHelperResult.displayMoveToInCheckAction).toBeFalsy()
  ...
  test.each([
    ...
    expect(claimFormHelperResult.displayRecommendAction).toBeFalsy()
    expect(claimFormHelperResult.displayRecommendToPayForm).toBeFalsy()
    expect(claimFormHelperResult.displayRecommendToRejectForm).toBe(expectedResult)
    expect(claimFormHelperResult.displayAuthorisePaymentForm).toBeFalsy()
    expect(claimFormHelperResult.displayRejectClaimForm).toBeFalsy()
    expect(claimFormHelperResult.displayMoveToInCheckAction).toBeFalsy()
    expect(claimFormHelperResult.subStatus).toBe('In check')
  ...
  test.each([
    ...
    expect(claimFormHelperResult.displayRecommendToPayForm).toBeFalsy()
    expect(claimFormHelperResult.displayRecommendToRejectForm).toBeFalsy()
    expect(claimFormHelperResult.displayAuthorisePaymentForm).toBe(expectedResult)
    expect(claimFormHelperResult.displayRejectClaimForm).toBeFalsy()
    expect(claimFormHelperResult.displayMoveToInCheckAction).toBeFalsy()
  ...
  test.each([
    ...
    expect(claimFormHelperResult.displayRecommendToRejectForm).toBeFalsy()
    expect(claimFormHelperResult.displayAuthorisePaymentForm).toBeFalsy()
    expect(claimFormHelperResult.displayRejectClaimForm).toBe(expectedResult)
    expect(claimFormHelperResult.displayMoveToInCheckAction).toBeFalsy()
  ...
  test.each([
    ...
    const claimFormHelperResult = await claimFormHelper(request, applicationReference, applicationStatus)
    expect(claimFormHelperResult.displayMoveToInCheckAction).toBe(true)
  })
})
