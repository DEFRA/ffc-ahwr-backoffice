...
describe('View Application test', () => {
  ...
  describe(`GET ${url} route`, () => {
    ...
    test('returns 200 application claim', async () => {
      ...
      expect($('tbody:nth-child(2) tr:nth-child(2) td:nth-child(2)').text()).toContain('Vet’s name')
      expect($('tbody:nth-child(2) tr:nth-child(2) td:nth-child(3)').text()).toContain('testVet')
      expect($('tbody:nth-child(2) tr:nth-child(2) td:nth-child(2)').text()).toContain('Vet’s RCVS number')
      expect($('tbody:nth-child(2) tr:nth-child(2) td:nth-child(3)').text()).toContain('1234234')
      expect($('tbody:nth-child(2) tr:nth-child(2) td:nth-child(2)').text()).toContain('Unique reference number (URN)')
      expect($('tbody:nth-child(2) tr:nth-child(2) td:nth-child(3)').text()).toContain('134242')
      expectPhaseBanner.ok($)
    })
