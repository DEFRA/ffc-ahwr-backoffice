...
describe('View Application test', () => {
  ...
  describe(`GET ${url} route`, () => {
    ...
    test('returns 200 application applied', async () => {
      ...
      expect($('tbody tr:nth-child(1) td:nth-child(2)').text()).toContain('06/06/2022')
      expect($('tbody tr:nth-child(2) td:nth-child(2)').text()).toContain('Yes')
      expect($('tbody tr:nth-child(3) td:nth-child(2)').text()).toContain('Sheep')
      expect($('tbody tr:nth-child(4) td:nth-child(2)').text()).toContain('At least 21')
      expect($('tbody tr:nth-child(5) td:nth-child(2)').text()).toContain('Yes')
