...
describe('View Application test', () => {
  ...
  describe(`GET ${url} route`, () => {
    ...
    test('returns 200 application data inputted', async () => {
      ...
      expect($('tbody:nth-child(2) tr:nth-child(5) td:nth-child(2)').text()).toContain('Percentage reduction in EPG?')
      expect($('tbody:nth-child(2) tr:nth-child(5) td:nth-child(3)').text()).toContain('40')
      expect($('tbody:nth-child(2) tr:nth-child(6) td:nth-child(2)').text()).toContain('Active chemical used in worming treatment')
      expect($('tbody:nth-child(2) tr:nth-child(6) td:nth-child(3)').text()).toContain('LV')
      expect($('tbody:nth-child(2) tr:nth-child(7) td:nth-child(2)').text()).toContain('Report given?')
      expect($('tbody:nth-child(2) tr:nth-child(7) td:nth-child(3)').text()).toContain('Yes')
      expect($('#claim').text()).toContain('Not yet able to claim')
      expect($('#payment').text()).toContain('Not yet paid')
      expectPhaseBanner.ok($)
    })
