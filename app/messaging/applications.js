...
async function getApplications (searchType, searchText, sessionId) {
  await sendMessage({ search: { type: searchType, text: searchText } }, backOfficeRequestMsgType, backOfficeRequestQueue, { sessionId })
