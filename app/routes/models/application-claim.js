...
const getApplicationClaimDetails = (application, applicationEvents, statusRow) => {
  if (
    !application.claimed &&
  ...
  return [
    statusRow,
    { key: { text: 'Date of review' }, value: { text: formatedDateToUk(data.visitDate) } },
    { key: { text: 'Date of testing' }, value: { text: formatedDateToUk(data.dateOfTesting) } },
    { key: { text: 'Date of claim' }, value: { text: formatedDate } },
    { key: { text: 'Review details confirmed' }, value: { text: upperFirstLetter(data.confirmCheckDetails) } },
    { key: { text: 'Vet’s name' }, value: { text: data.vetName } },
    { key: { text: 'Vet’s RCVS number' }, value: { text: data.vetRcvs } },
    { key: { text: 'Test results unique reference number (URN)' }, value: { text: data.urnResult } }
  ]
}
