...
module.exports = {
  ...
  options: {
    ...
    handler: async (request, h) => {
      ...
      const isAgreementAgreedAndUserIsAdminAuthoriserRecommender = withdrawLinkStatus.includes(application.status.status) && (mappedAuth.isAdministrator || mappedAuth.isAuthoriser || (endemics.enabled && (mappedAuth.isRecommender || mappedAuth.isAuthoriser)))
